var pointapi = "1ab627320337b55a37f95f68c3756c74";
var movieId;
...
function loadPage() {
  window.location.assign("indexs.html?q=" + encodeURIComponent(this.id));
}
...
function getTitle() {
  ...
  if (title.trim().length === 0) {
    ...
    error1.addClass("is-size-3 is-family-sans-serif ");
